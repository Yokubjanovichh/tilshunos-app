  ...
  return (
    <Container size="xl" style={{ display: "flex", flexDirection: "column", gap: "30px", justifyContent: "center", alignItems: "center" }}>
      ...
      <Text size="xl" style={{ textAlign: "center" }}>
        <Title order={2}>Dasturning huquqiy asoslari </Title>“<Link to="https://auxwords.uz/index.html">Auxwords.uz</Link>” dasturi …..guvohnoma bilan tasdiqlangan.
      </Text>
